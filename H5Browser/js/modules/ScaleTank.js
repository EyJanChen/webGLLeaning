class ScaleTank {
  ...
  initProgram() {
    ...
    ShaderUtil.loadShader(this._gl, ShaderUtil.INDEX_SHADER_SCALE, this.loadProgramSuccess.bind(this));
  }
  ...
  run() {
    ...
    let uScale = this._gl.getUniformLocation(this._program, 'u_scale');
